...
class Bot:
    ...
    def fight(self,current_game_state,player):
        ...
        if player=="1":
            ...
            X = current_game_state.tuple_without_p1Buttons()
            ...
            for arr in prediction:
                for i in range(len(arr)):
                    if i == 0:
                        self.buttn.up = bool(arr[i])
                    elif i == 1:
                        self.buttn.down = bool(arr[i])
                    elif i == 2:
                        self.buttn.right = bool(arr[i])
                    elif i == 3:
                        self.buttn.left = bool(arr[i])
                    elif i == 4:
                        self.buttn.Y = bool(arr[i])
                    elif i == 5:
                        self.buttn.B = bool(arr[i])
                    elif i == 6:
                        self.buttn.X = bool(arr[i])
                    elif i == 7:
                        self.buttn.A = bool(arr[i])
                    elif i == 8:
                        self.buttn.L = bool(arr[i])
                    elif i == 9:
                        self.buttn.R = bool(arr[i])
